...
JDBCConn.prototype.initialize = function(config, callback) {
  ...
  if (sdf === null) {    
    sdf = java.newInstanceSync('java.text.SimpleDateFormat', 'yyyy-MM-dd\'T\'HH:mm:ss.SSS\'Z\'');
    sdf.setTimeZoneSync(java.import('java.util.TimeZone').getTimeZoneSync('UTC'));    
  }
            ...
            setImmediate(function(){
              ...
              for(var a= 1; a <= cc; a++) {
                ...
                if (isNumber[colType]) {
                  ...
                  rawValue = Date.parse(sdf.formatSync(resultset.getDateSync(a)));
                } else if (colType === 93) {
                  rawValue = resultset.getTimestampSync(a);
                } else if (colType === 16) {
